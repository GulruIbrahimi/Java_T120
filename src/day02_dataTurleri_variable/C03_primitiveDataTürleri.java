...
public class C03_primitiveDataTürleri {
    ...
    public static void main(String[] args) {
        ...
        // 1- boolean : mantiksal degerler olan true ve false kabul eder
        ...
        System.out.println(db3); // 3,33333333335
        ...
        System.out.println("Verilen iki sayinin çarpımı " + sayi1*sayi2);
